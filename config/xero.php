...
return [
    ...
    */
     ...
     * Set the scopes
     */
    'scopes' => env('XERO_SCOPES', 'openid email profile offline_access accounting.settings accounting.invoices accounting.payments accounting.contacts payroll.settings payroll.employees payroll.timesheets payroll.payruns payroll.payslip'),
];